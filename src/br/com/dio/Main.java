...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("8 - Solicitar dica");
    ...
    private static void startGame(final Map<String, String> positions) {
        ...
        for (int i = 0; i < BOARD_LIMIT; i++) {
            ...
            for (int j = 0; j < BOARD_LIMIT; j++) {
                // Inicializa um tabuleiro vazio (todos os valores são null e não fixos)
                var currentSpace = new Space(0, false); // 0 significa célula vazia
    ...
    private static void inputNumber() {
        ...
        if (!board.changeValue(col, row, value)) {
            System.out.printf("A posição [%s,%s] tem um valor fixo ou o número é inválido\n", col, row);
        }
    }
    ...
    private static void requestHint() {
        ...
        System.out.println("Informe a coluna para a dica");
        var col = runUntilGetValidNumber(0, 8);
        System.out.println("Informe a linha para a dica");
        var row = runUntilGetValidNumber(0, 8);
        String hint = board.getHint(col, row);
